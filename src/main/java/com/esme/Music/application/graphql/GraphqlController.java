...
public class GraphqlController {
    ...
    public GraphqlController(MusicResolver musicResolver) {
        GraphQLSchema schema = new GraphQLSchemaGenerator() //Déclaration schéma
//        .withBasePackages("com.sudria.demo.graphql")
                .withOperationsFromSingletons(musicResolver)
                .generate();
